...
4. Create EC2 in "stevie-vpc-a" named "Local"
...
```
4. Create "Windows" instance in "stevie-vpc-a" named "Windows"
...
```bash
   Domain name: the same name of your domain(stevie.click)
   Description: ---
...
- type "wwww.stevie-aws.click". show which content is seen "local instance content" in VPC 
- go to the public browser than type browser: "wwww.stevie-aws.click" than show that, N.Virginia instance is seen on public internet.

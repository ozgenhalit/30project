...
- discuss about how to connect to the "stevie-az1b-private-subnet" instance
...
Subnet          : stevie-az1b-private-subnet
Security Group  : 
...
Target ----> Nat Gateway ----> stevie-nat-gateway
```
- click save routes
...
- Select stevie-nat-gateway --- > Actions ---> delete Nat Gateway
...
- Go to Route Table and select "stevie-private-rt"

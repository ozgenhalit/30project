# Hands-on : Setting Cloudwatch Alarm Events, and Logging
...
```
Dashboard Name: Stevie_Dashboard
```
...
Notification:
  ...
  - Select an SNS topic : 
    - Create new topic
      - Create a new topic… : Stevie-alarm
...
- Review
	- Role Name : Steviecloudwatchlog  
  - Role Description: Stevie Cloudwatch EC2 logs access role

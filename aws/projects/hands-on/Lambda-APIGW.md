...
- Create a bucket of `stevie.source.lambda` with following properties,

```text
Bucket name                 : stevie.source.lambda
Region                      : N.Virginia
...
- Create another bucket of `stevie.destination.lambda` with following properties,

```text
Bucket name                 : stevie.destination.lambda
Region                      : N.Virginia
Block all public access     : Checked (KEEP BlOCKED)
Versioning                  : Disabled
Tagging                     : 0 Tags
...
def lambda_handler(event, context):
   destination_bucket_name = 'stevie.destination.lambda'
...
- Select S3 bucket named 'stevie.source.lambda'

- Upload any files to source bucket

- Go to the S3 bucket named 'stevie.destination.lambda' and show the uploaded files to the source bucket.
